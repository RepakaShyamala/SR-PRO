...
def start_anpr(input_files):
    ...
    model = OCR(
    modelFile=r"D:\Desktop\ANPR AND ATCC PRO\binary_128_0.50_ver3 (1).pb",
    labelFile=r"D:\Desktop\ANPR AND ATCC PRO\binary_128_0.50_labels_ver2.txt"
)
...
if __name__ == "__main__":
	video_file=[r"D:\Desktop\Old desktop files\anpr.videos\Automatic Number Plate Recognition (ANPR) _ Vehicle Number Plate Recognition (1).mp4"]
